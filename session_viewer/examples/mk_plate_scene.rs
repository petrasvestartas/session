...
fn main() {
    let out = std::env::args()
        .nth(1)
        .unwrap_or_else(|| "target/plate.pb".into());
    ...
    for i in 0..n {
        let x0 = i as f64 * s;
        polys.push(vec![
            session_rust::Point::new(x0, 0.0, 0.0),
            session_rust::Point::new(x0 + s, 0.0, 0.0),
            session_rust::Point::new(x0 + s, 0.0, 8.0),
            session_rust::Point::new(x0, 0.0, 8.0),
        ]);
        polys.push(vec![
            session_rust::Point::new(x0, 400.0, 0.0),
            session_rust::Point::new(x0 + s, 400.0, 0.0),
            session_rust::Point::new(x0 + s, 400.0, 8.0),
            session_rust::Point::new(x0, 400.0, 8.0),
        ]);
        polys.push(vec![
            session_rust::Point::new(0.0, x0, 0.0),
            session_rust::Point::new(0.0, x0 + s, 0.0),
            session_rust::Point::new(0.0, x0 + s, 8.0),
            session_rust::Point::new(0.0, x0, 8.0),
        ]);
        polys.push(vec![
            session_rust::Point::new(400.0, x0, 0.0),
            session_rust::Point::new(400.0, x0 + s, 0.0),
            session_rust::Point::new(400.0, x0 + s, 8.0),
            session_rust::Point::new(400.0, x0, 8.0),
        ]);
    }
