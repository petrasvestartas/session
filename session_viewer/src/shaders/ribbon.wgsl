...
struct LineUniform{
    thickness: f32, // on-screen half-width, px
...
// One segment = 6 verts (2 triangles) forming a screen-space CAPSULE: the quad extends
// half-width past both ends and the fragment shader rounds the caps with an SDF —
// ROUND line ends, and polyline corners join smoothly because neighbouring caps overlap.
