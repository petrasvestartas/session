...
pub struct Pipelines{
    ...
    pub cylinder: wgpu::RenderPipeline, // 3D edges — LINEWORK_SOLID mode
    pub ribbon: wgpu::RenderPipeline,   // flat camera-facing edges — 2 tris/segment (default)
    pub sphere: wgpu::RenderPipeline,   // 3D dots — LINEWORK_SOLID mode (also handles later)
    pub glyph: wgpu::RenderPipeline,    // flat circle dots — 1 tri each (default)
