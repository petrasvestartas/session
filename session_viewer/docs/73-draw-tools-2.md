# 73 Draw tools II — polyline, rectangle, box, and the ghost preview
...
Lesson 45 shipped curves with no way to draw one — the tool trait, the command bus and
...
`74-snapping.md` — drawing becomes *precise*: endpoints, vertices, and grid intersections within a
