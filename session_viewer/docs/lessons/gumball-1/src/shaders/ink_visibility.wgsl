...
// A texel's depth at one sample; outside the viewport is cleared.
...
// How far a fitted plane may miss.
...
// Do this fragment and its neighbour along `dir` share a surface?
...
// The carry's verdict, shared by strokes and discs.
...
// The unit texel step away from the stroke.
...
// A stroke fragment's surface, fitted from two texels.

// Is a stroke fragment visible?
...
// A disc fragment's surface, fitted along both axes.

// Is a disc fragment visible?
...
// Orthographic rays are parallel; camera position does not matter.
...
// At a corner the x and y fits can be different faces.
...
// Is this ink fragment in front of the surface under it?
