...
/// One more slice of cloud `idx`: rows and resident point.
...
/// One more slice of sheet `idx`: rows and resident segment.
...
pub struct App {
    ...
    command_keys: Option<app::input::CommandKeys>, // command box key listener
    layer_clicks: Option<app::input::LayerClicks>, // layers panel click listener
}
