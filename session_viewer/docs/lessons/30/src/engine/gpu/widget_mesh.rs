...
/// Spin a (distance, radius) profile around `axis`.
...
/// A sphere at distance `at` along `axis`.
...
/// Sample a parametric surface into triangles.
fn surface(
    out: &mut Vec<Vertex>,
    rows: usize,
    columns: usize,
...
mod tests {
    ...
    #[test]
    /// Every vertex is finite and every handle is present.
