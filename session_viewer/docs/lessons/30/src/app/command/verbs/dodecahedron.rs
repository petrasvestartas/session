...
pub const SPEC: Spec = Spec {
    names: &["Dodecahedron"],
    aliases: &[],
    hint: "Dodecahedron (Brep Mesh): center, radius to the corners · Example: Dodecahedron 0,0,0 10",
    options: &["Dodecahedron Brep", "Dodecahedron Mesh"],
    arity: None,
...
fn build(part: &Part, option: &str) -> Result<Geometry, String> {
    shape::polyhedron_of(part, option, make, "dodecahedron")
}
...
mod tests {
    ...
    /// Every corner at the radius; the Brep option is a closed solid of 12 faces.
    #[test]
