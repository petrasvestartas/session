    ...
    // --8<-- [end:step-3h]
        ...
        .frame(
            egui::Frame::new()
                ...
                // --8<-- [start:current-16-step-3c]
                .inner_margin(egui::Margin::symmetric(6, 4)),
                // --8<-- [end:current-16-step-3c]
        )
        .show_inside(root, |ui| {
            // --8<-- [start:step-3i]
            ...
            ui.painter().hline(
                ...
                // --8<-- [start:current-16-step-3d]
                ui.max_rect().top() - 4.0,
                // --8<-- [end:current-16-step-3d]
            ...
            ui.horizontal(|ui| {
                ...
                let collapse = ui
                    // --8<-- [start:current-16-step-3h]
                    .button(if model.command_expanded { "−" } else { "+" })
                    // --8<-- [end:current-16-step-3h]
                ...
                if collapse.clicked() {
                    // --8<-- [start:current-16-step-3i]
                    model.command_expanded = !model.command_expanded;
                    // --8<-- [end:current-16-step-3i]
                    ui.ctx().request_repaint();
                }
            });
        });
