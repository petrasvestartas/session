...
pub enum Command {
    ...
    // --8<-- [start:current-15-step-1a]
    Opacity(f32),             // face alpha, 0 x-ray to 1 solid
    // --8<-- [end:current-15-step-1a]
    // --8<-- [start:step-5a]
