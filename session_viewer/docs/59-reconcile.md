# 59 Reconcile II — diff by guid, touch only what changed
...
> (When the BVH lands, [62](62-scene-bvh.md) extends this exact function with the touched-rows
...
`60-save.md` — the reverse trip. An in-viewer edit marks the object dirty; a debounce coalesces the
