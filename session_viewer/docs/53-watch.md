# 53 Watch — external edits flow back in
...
**Close the loop with 50's save.** When Step 4 of lesson 52 writes bytes, stamp their hash so the very
...
`56-screen-to-ray.md` — Phase 7 opens: picking. The mouse is a 2D point; everything selectable is 3D. The
