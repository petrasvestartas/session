# 93 GTAO — ambient occlusion at constant quality
...
kernel's `Xform::inverse` used to be affine-only; lesson 68 found and fixed it kernel-wide. The
...
`94-arctic-gi.md` — the look, completed: sky-visibility from the bent normal (creases darken toward
