...
> Lesson [90](90-gtao.md) samples this frame's depth buffer for ambient occlusion, and lesson
> [115](115-hiz-occlusion.md) builds a hi-Z pyramid from it. Both cost one field access — because
...
is the other: `None` means no depth attachment, which is what lesson 76's gumball overlay needs.
...
that were literals inside it become the two parameters lesson 76's overlay pass needs:
