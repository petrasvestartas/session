...
> Lesson [89](89-gtao.md) samples this frame's depth buffer for ambient occlusion, and lesson
> [114](114-hiz-occlusion.md) builds a hi-Z pyramid from it. Both cost one field access — because
