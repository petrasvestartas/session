# 81 GTAO — ambient occlusion at constant quality
...
kernel's `Xform::inverse` used to be affine-only; lesson 56 found and fixed it kernel-wide. The
...
`82-arctic-gi.md` — the look, completed: sky-visibility from the bent normal (creases darken toward
