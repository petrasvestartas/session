...
![Where this step sits in the viewer: Scene + walk, Lanes, with 10 of 11 zones built so far.](illustrations/locator-67a681912a.svg)
...
- The app module list, complete: what a scene is, how it arrives, and how it is driven - and still not one wgpu type named anywhere in it.

### Step 9 · Selection and the status line

![Where this step sits in the viewer: Shell, State, with 10 of 11 zones built so far.](illustrations/locator-a60ba091df.svg)
