# 92 GTAO — ambient occlusion at constant quality
...
kernel's `Xform::inverse` used to be affine-only; lesson 67 found and fixed it kernel-wide. The
...
`93-arctic-gi.md` — the look, completed: sky-visibility from the bent normal (creases darken toward
