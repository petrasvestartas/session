# 51 Performance and memory — measured, one item at a time

> Last refactor lesson. Start from the end of lesson 50. Unlike 46-50 this lesson CHANGES
...
<svg viewBox="0 0 720 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="before: render requests the next frame forever; after: events set needs_frame and one frame is drawn; plus three measured memory fixes as bars" style="max-width:100%;height:auto;font:12px ui-monospace,monospace">
  ...
  <text x="510" y="20" fill="#7ed37e" font-size="11" text-anchor="middle">after — render on demand (lesson 51)</text>
...
`docs/51_refactored/ARCHITECTURE.md` over `session_viewer/ARCHITECTURE.md`. The whole end-of-51
