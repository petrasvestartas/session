# 89 Textures — paint an image onto geometry (optional appendix)
...
> (76's label atlas also uses group 3 — but on the TEXT pipeline; the material's group 3 is on the
