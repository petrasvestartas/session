# 50 A producer's signature names what it can reach

> Lesson [52](52-nurbscurve.md) adds a geometry type by writing one file and two lines; lesson
> [114](114-id-buffer-picking.md) needs to know which face a triangle came from, and adds one
...
cargo xtest
python3 docs/_replay_check.py --moves <end-of-49 tree> /tmp/w50 docs/50-walk-sinks.md
./docs/_gate.sh                # twice
...
docs/50-walk-sinks.md: 42 ops, 0 failed
gate OK                        (both runs)
