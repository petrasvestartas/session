...
> Lesson [55](55-nurbscurve.md) adds a geometry type by writing one file and two lines; lesson
> [117](117-id-buffer-picking.md) needs to know which face a triangle came from, and adds one
...
came from; lesson 117 adds a field here and touches no family file.
...
/// FACE or EDGE of the kernel geometry it came from; when lesson 117 adds that, it adds a field
