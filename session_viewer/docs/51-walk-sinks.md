...
> Lesson [57](57-nurbscurve.md) adds a geometry type by writing one file and two lines; lesson
> [119](119-id-buffer-picking.md) needs to know which face a triangle came from, and adds one
...
came from; lesson 119 adds a field here and touches no family file.
...
/// FACE or EDGE of the kernel geometry it came from; when lesson 119 adds that, it adds a field
