# 76 Text labels — names in the scene
...
```
Ch 75: tree ↔ viewport — one selection, two views.
Ch 76: LABELS. A glyph atlas (ASCII on a fixed CELL grid, R8Unorm, baked once — archive text.rs) +
...
`77-control-points.md` — Phase 13: sub-object editing. F10 turns control points on; the gumball grabs
