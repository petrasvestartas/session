...
/// Kernel width (dimensionlesss, default 1.0) - the radius encoding's negative lane
/// px multiplier 0.0 = plain global default
/// walk:session flips negatives into the positive world mm lane for planar 2d drawings
