...
<svg viewBox="0 0 720 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="walk_geometry: the Geometry arms on the left write only the Walk sinks their producer is handed, and return a Row that scene.rs turns into the object row" style="max-width:100%;height:auto;font:12px ui-monospace,monospace">
  ...
  <text x="360" y="27" fill="#d7dae0" font-size="11" text-anchor="middle">walk_geometry(w: &amp;mut Walk, cx: &amp;WalkCx, geom: &amp;Geometry) -&gt; Row      — app/walk/mod.rs, lesson 50</text>
  ...
  <g fill="#888" font-size="10">
    ...
    <text x="14" y="292">deleted here: push_mesh and the 13-arm match in scene.rs; amber = app side, green = new in lesson 50</text>
  </g>
</svg>
...
Lesson [51](51-performance-memory.md) — performance and memory: render on demand, one owner per
