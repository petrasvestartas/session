# 58 NurbsSurface — tessellate once, transform matrices forever
...
**(3) WORLD BOX and (4) PICK** — born with their maps: [66](66-scene-bvh.md) boxes the surface
(`OBB::from_nurbssurface`, kernel-exact) and [69](69-raycast-meshes.md) picks the cached
...
`59-isocurves.md` — the tessellated body reads as a surface only when its **edges** say so:
