# 96 Measure + status bar — the viewer answers questions

> **Big picture.** *Phase 14.* CAD models exist to be interrogated: how long, how far apart, what
> angle, how big. Lesson 64's `probe` was secretly the prototype — a Get-loop conversation ending in
...
`97-dev-toolbox.md` — the developer-experience lesson: a headless selftest, GPU errors that surface
