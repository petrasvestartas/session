...
```
Ch 51: visibility — Phase 7 closed; the scene is fully interactive but mute.
...
`53-command-bus.md` — THE interface arrives: a command line docked at the screen edge, a registry of
