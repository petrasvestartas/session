# 46 NurbsSurface — tessellate once, transform matrices forever
...
**(3) WORLD BOX and (4) PICK** — born with their maps: [54](54-scene-bvh.md) boxes the surface
(`OBB::from_nurbssurface`, kernel-exact) and [57](57-raycast-meshes.md) picks the cached
...
`47-isocurves.md` — the tessellated body reads as a surface only when its **edges** say so:
