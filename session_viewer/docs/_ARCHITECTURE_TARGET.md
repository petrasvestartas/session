...
- `session_viewer/docs/NN-*.md` — 63 filenames renamed (`45-nurbscurve.md` → `58-nurbscurve.md` … `107-id-buffer-picking.md` → `120-id-buffer-picking.md`); the 40-44 chain renumber is **DONE (2026-08-29)**: `43-lane-structs.md` deleted, `41-potree-look.md` split into `41-potree-look.md` + `42-cloud-normals.md`, `41-cloud-scenes.md` → `43-cloud-scenes.md`, `42-streaming-cloud.md` → `44-streaming-cloud.md`, `45-cloud-octree.md` unchanged. What REMAINS is the +7 shift of the 63 files from `45-nurbscurve.md` → `58-nurbscurve.md` through `107-id-buffer-picking.md` → `120-id-buffer-picking.md`.
