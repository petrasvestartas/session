# 57 Trimmed surfaces — first-class, and the every-map rule becomes structure
...
`58-gpu-arena.md` — every geometry type renders; now the session infrastructure: the flat GPU
