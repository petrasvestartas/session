...
Write your answers down before opening the hints. Comparing a wrong prediction against the answer teaches more than reading the answer first — and you will not be able to un-read it.

## Hints, one at a time

??? tip "Hint 1 · Where the plane belongs"
...
??? tip "Hint 2 · Getting four floats everywhere"
...
??? tip "Hint 6 · Paying nothing when off"
...
Open this only after your own design is written down.

??? success "A design that satisfies the constraints"
