# 99 Text labels — names in the scene
...
Ch 77: LABELS. A glyph atlas (ASCII on a fixed CELL grid, R8Unorm, baked once — archive text.rs) +
       ...
       labels sit at each row's PLACED box top (52's world_boxes). Pipeline built in Pipelines::new
...
`100-control-points.md` — Phase 13: sub-object editing. F10 turns control points on; the gumball grabs
