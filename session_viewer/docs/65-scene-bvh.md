# 65 Scene BVH — one broad-phase, three consumers
...
boxes in, is the simpler contract — and the per-session caches stay untouched for lesson 68's
...
`66-frustum-culling.md` — extract the view frustum's 6 planes from the ANCHORED `view_proj`
