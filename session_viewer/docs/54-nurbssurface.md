# 54 NurbsSurface — tessellate once, transform matrices forever
...
**(3) WORLD BOX and (4) PICK** — born with their maps: [62](62-scene-bvh.md) boxes the surface
(`OBB::from_nurbssurface`, kernel-exact) and [65](65-raycast-meshes.md) picks the cached
...
`55-isocurves.md` — the tessellated body reads as a surface only when its **edges** say so:
