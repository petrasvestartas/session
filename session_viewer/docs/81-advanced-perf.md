# 81 Advanced perf — headroom beyond the stress file

> **Big picture.** *Phase 13 closes.* The viewer already carries its two acceptance scenes easily —
> batching (30/31), culling (41), render-on-demand (71), and the half-res AO (72) did the heavy
...
- Confirm the baseline numbers on the acceptance scene — the 10-sheet manifest
  (`scenes/drawings.json`) — and write them into `_ROADMAP.md`'s capstone entry — the capstone (82)
...
`82-capstone.md` — everything, together: load the floor model, run the whole loop — pick, tree,
