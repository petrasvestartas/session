# 65 Watch — external edits flow back in
...
**Close the loop with 59's save.** When Step 4 of lesson 64 writes bytes, stamp their hash so the very
...
`68-screen-to-ray.md` — Phase 7 opens: picking. The mouse is a 2D point; everything selectable is 3D. The
