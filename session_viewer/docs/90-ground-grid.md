# 90 Analytic ground + infinite grid — the stage
...
4×4 inverse — fixed during lesson 67; this matrix contains the projection, which the old affine-only
...
`91-render-on-demand.md` — the single biggest perf win in the whole course, and it never touches the
