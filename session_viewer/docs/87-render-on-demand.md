# 87 Render-on-demand — the biggest win never touches the image
...
`88-gtao.md` — ambient occlusion, the constant-quality way: half-resolution GTAO with a fixed tap
