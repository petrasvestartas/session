# 68 Screen → ray — unproject the mouse into a world ray
...
> in stages: turn the cursor into a ray (this lesson), cast it (55–57), select with it (58).

Picking starts here. The cursor is a 2D pixel; everything selectable is 3D. Every pick in Phase 7 —
mesh (55), vertex/edge/face (56), line/point (57), marquee (58) — begins by turning that pixel into a
...
`69-raycast-meshes.md` — cast this ray at the meshes. Broad-phase with the 40 BVH to a short candidate
