# 85 Draw tools II — polyline, rectangle, box, and the ghost preview
...
`86-snapping.md` — drawing becomes *precise*: endpoints, vertices, and grid intersections within a
