# 93 Arctic + cheap GI — a better default look for the same money
...
`94-outline-aa.md` — the last archive-look piece: the crisp selection outline, rebuilt without the
