...
mesh (46), vertex/edge/face (47), line/point (48), marquee (49) — begins by turning that pixel into a
...
```
Ch 44: watch — external file edits reconcile back in.
Ch 45: SCREEN → RAY. A cursor pixel → NDC (x,y ∈ [-1,1], y flipped for top-down pixels) → unproject
...
`46-raycast-meshes.md` — cast this ray at the meshes. Broad-phase with the 36 BVH to a short candidate
