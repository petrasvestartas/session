# 91 Analytic ground + infinite grid — the stage
...
4×4 inverse — fixed during lesson 68; this matrix contains the projection, which the old affine-only
...
`92-render-on-demand.md` — the single biggest perf win in the whole course, and it never touches the
