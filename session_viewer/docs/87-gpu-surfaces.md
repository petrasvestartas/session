# 87 GPU surfaces — tensor product in compute, the arena gets a producer
...
`88-gpu-trimming.md` — the lesson the CDT does not survive: trim loops become a per-fragment
