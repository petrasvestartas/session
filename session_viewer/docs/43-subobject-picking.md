# 43 Sub-object picking — vertex, edge, or face
...
> the gumball (52+) and control-point editing (73) possible later; the screen-pixel radius trick it
...
The exact inverse of 41's unproject: world → camera-relative (`− origin`) → clip (`view_proj`) → NDC →
...
`44-pick-thin-geometry.md` — Lines, polylines, and points are 1D and 0D: a ray passes *through* them,
