...
/// Two adjacent faces count as one flat region above this normal dot (~0.8 deg), so the edge
/// between them is interior tessellation rather than an edge of the shape.
const COPLANAR_DOT: f64 = 0.9999;
