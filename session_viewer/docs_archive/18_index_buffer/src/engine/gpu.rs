...
pub struct Gpu {
    ...
    pub index_buffer: wgpu::Buffer,          // Vertex
    pub num_indices: u32,                    // Vertex
    pub time: f32,
...
impl Gpu {
    ...
    pub async fn new(window: std::sync::Arc<winit::window::Window>) -> anyhow::Result<Self> {
        ...
        const H: f32 = 500.0; // half size cube
        const CUBE: &[Vertex] = &[
        ...
        let vertex_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor{
            label: Some("cube.vbo"),
            contents: bytemuck::cast_slice(CUBE), // &[Vertex] -> &[u8]
        ...
        let num_indices = CUBE_IDX.len() as u32;
    ...
    pub fn clear(&mut self, color: wgpu::Color, view_proj: &Xform) -> anyhow::Result<()> {
...

        {
            ...
            pass.draw_indexed(0..self.num_indices, 0, 0..1) // 3 vertices, 1 instance
        }
