...
impl Gpu {
    ...
    pub async fn new(window: std::sync::Arc<winit::window::Window>) -> anyhow::Result<Self> {
        ...
        Ok(Self { surface, device, queue, config, pipelines, mvp_buffer, mvp_bind_group, vertex_buffer, num_vertices, time:0.0, time_buffer, time_bind_group })
    }
