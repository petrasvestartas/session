...
CLASS_NAMES=("aabb" "brep" "bvh" "closest" "color" "edge" "encoders" "graph" "intersection" "knot" "line" "mesh" "mesh_iso" "nurbscurve" "nurbssurface" "obb" "obj" "objects" "plane" "point" "pointcloud" "polyline" "primitives" "quaternion" "remesh_nurbssurface_grid" "remesh_nurbssurface_adaptive" "rtree" "session" "session_config" "tolerance" "tree" "treenode" "triangulation_2d" "trimmedsurface" "vector" "vertex" "xform")
