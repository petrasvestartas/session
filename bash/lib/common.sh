...
CLASS_NAMES=("aabb" "brep" "bvh" "closest" "color" "edge" "encoders" "graph" "intersection" "knot" "line" "mesh" "mesh_iso" "nurbscurve" "nurbssurface" "obb" "obj" "objects" "plane" "point" "pointcloud" "polyline" "primitives" "quaternion" "rtree" "session" "session_config" "tolerance" "tree" "treenode" "triangulation_2d" "trimmedsurface" "vector" "vertex" "xform")
