...
def ray_box(line: Line, box: BoundingBox, t0: float, t1: float) -> Optional[List[Point]]:
    """
...
def ray_triangle(line: Line, v0: Point, v1: Point, v2: Point, epsilon: float) -> Optional[Point]:
    """
