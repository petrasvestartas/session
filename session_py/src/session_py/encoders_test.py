...
def test_decode_node_list():
    ...
    point_data = {"type": "Point", "x": 1.0, "y": 2.0, "z": 3.0, "guid": "test", "name": "p1"}
    data = [point_data, {"type": "Point", "x": 4.0, "y": 5.0, "z": 6.0, "guid": "test2", "name": "p2"}]
    result = decode_node(data)
    assert len(result) == 2
...
def test_decode_node_dict():
    ...
    data = {"type": "Vector", "x": 1.0, "y": 2.0, "z": 3.0, "guid": "test", "name": "v1"}
    result = decode_node(data)
